...
typedef int (*ShellCommandFunction)(void);
typedef int (*ShellVarGetFunction)(void *var);
typedef int (*ShellVarSetFunction)(void *var, int value);
...
#define     SHELL_AGENCY_FUNC(_func, ...) \
    ...
    #define SHELL_EXPORT_CMD(_attr, _name, _func, _desc, ...) \
            ...
            { \
                ...
                .data.cmd.function = (ShellCommandFunction)_func, \
...
typedef struct shell_command
{
    ...
    union
    {
        ...
        {
            const char *name;                                   /**< 命令名 */
            ShellCommandFunction function;                      /**< 命令执行函数 */
...
{
    void *var;                                                  /**< 变量引用 */
    ShellVarGetFunction get;                                    /**< 变量get方法 */
    ShellVarSetFunction set;                                    /**< 变量set方法 */
} ShellNodeVarAttr;
