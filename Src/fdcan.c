...
void MX_FDCAN2_Init(void)
{
  ...
  if (HAL_FDCAN_ConfigInterruptLines(&hfdcan2, FDCAN_IT_GROUP_RX_FIFO1|FDCAN_IT_GROUP_TX_FIFO_ERROR, 
									FDCAN_INTERRUPT_LINE1) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_FDCAN_ActivateNotification(&hfdcan2, FDCAN_IT_RX_FIFO1_NEW_MESSAGE| FDCAN_IT_TX_FIFO_EMPTY, 0) != HAL_OK)
  {
    Error_Handler();
  }
