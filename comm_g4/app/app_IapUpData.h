...
#define FLASH_OPERATION_FLAG_BASS   0x08008000UL  /* 标志存储区地址 页16-17(4KB)*/
#define FLASH_RUNING_AREA_APP       0x08009000UL  /* 运行区地址     页18-40(46K)*/
#define FLASH_RUNING_AREA_BACKUP    0x08014800UL  /* 备份区地址     页41-63(46K)*/
...
typedef struct 
{
   Rxbuff                 rx_buf;					  /*接收到的包满存一次备份区FLASH*/		
