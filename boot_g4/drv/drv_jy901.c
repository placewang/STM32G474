...
void jy901_clear_output_packets(uint16_t packets)
{
  packets &= JY901_OUTPUT_ALL;
...
void jy901_send_pwm_param(uint8_t port, uint16_t high_us, uint16_t period_us)
{
    ...
    uint8_t reg_high = 0x12 + port;
    uint8_t reg_period = 0x16 + port;
