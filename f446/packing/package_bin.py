...
class PackageConfig:
    ...
    def build_default_output_path(self, input_path: Path) -> Path:
        ...
        return input_path.with_name(f"{output_name}{self.default_output_suffix}")
